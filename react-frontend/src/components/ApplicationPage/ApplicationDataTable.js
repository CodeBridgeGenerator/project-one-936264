...
const dropdownArrayTemplate1 = (rowData, { rowIndex }) => <p >{rowData.Language}</p>
const badgeTemplate2 = (rowData, { rowIndex }) => <Badge value={Number(rowData.Performance)}  />
...
<Column field="Language" header="Language" body={dropdownArrayTemplate1} filter={selectedFilterFields.includes("Language")} hidden={selectedHideFields?.includes("Language")}  style={{ minWidth: "8rem" }} />
<Column field="Performance" header="Performance" body={badgeTemplate2} filter={selectedFilterFields.includes("Performance")} hidden={selectedHideFields?.includes("Performance")}  sortable style={{ minWidth: "8rem" }} />
