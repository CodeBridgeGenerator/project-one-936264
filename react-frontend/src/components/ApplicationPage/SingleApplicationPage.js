...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-primary">Performance</label><p className="m-0 ml-3" ><Badge id="Performance" value={Number(_entity?.Performance)}/></p></div>
